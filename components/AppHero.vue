 ...
 <section class="wrapper md:flex md:space-x-4 items-center">
      <div class="prose md:w-1/2">
        ...
        <h2 class="font-normal mt-3">
          ...
          all’unico <span class="text-primary">video corso online</span> di Primo
          Soccorso.
        </h2>
        <p class="text-2xl">
          <strong>Prenota ora e ottieni il 10% di sconto</strong>
        </p>
      </div>
      ...
      <div class="md:w-1/2">
        ...
        <div class="flex items-center m-auto max-w-lg mt-3">
          ...
          <p class="text-sm">
            ...
            certificato. 
            <small><em>
            Certificato rilasciato da un Centro di Formazione accreditato al 118 regionale
            </em></small>
          </p>
        </div>
      </div>
